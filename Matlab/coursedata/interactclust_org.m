function o2c = interactclust_org(x,linkage,showfusion)
...
while ~exit_flag,
   figure(fignum)
   [Nc_new,col_new,o2c_new,exit_flag] = Clust_Clickdend_org(Dend,'n',obj2pos,minY);
   if ~exit_flag,
      Nc = Nc_new;
      col = col_new;
      o2c = o2c_new;
