...
persistent WARN % show warning about software implementation just once
if isempty(WARN), WARN = false; end
...
elseif mapping_task(argin,'training')
  ...
  if (featsubset>dim)
     error('I cannot extract more than %d features from dataset.',dim);
  end
  v = cell(L,1);
